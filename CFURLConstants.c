...
const CFStringRef kCFURLVolumeSupportsImmutableFilesKey = CFSTR("NSURLVolumeSupportsImmutableFilesKey");
const CFStringRef kCFURLVolumeSupportsAccessPermissionsKey = CFSTR("NSURLVolumeSupportsAccessPermissionsKey");
const CFStringRef kCFURLVolumeSupportsFileProtectionKey = CFSTR("NSURLVolumeSupportsFileProtectionKey");
